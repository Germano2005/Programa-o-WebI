...
<body>
<h1> Fundamentos do PHP - listaL3 - exercício 2 - resposta do PHP </h1>
<p></p>
<?php
...
$notaMaior = max($vetorAlunos);
$melhorAluno = array_search($notaMaior, $vetorAlunos);
echo "<p> A maior nota é <span>$notaMaior</span> do aluno <span>$melhorAluno</span></p>";
